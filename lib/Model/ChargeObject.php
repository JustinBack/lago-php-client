...
class ChargeObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'group_properties' => '\LagoClient\Model\GroupPropertiesObject[]'
    ];
    ...
    */
     ...
     * Sets charge_model
     *
     * @param string $charge_model Specifies the pricing model used for the calculation of the final fee. It can be `standard`, `graduated`, `package`, `percentage` or `volume`.
     *
     * @return self
     */
     ...
     *
     * @return \LagoClient\Model\GroupPropertiesObject[]|null
     */
     ...
     *
     * @param \LagoClient\Model\GroupPropertiesObject[]|null $group_properties All charge information, sorted by groups.
     *
     * @return self
     */
