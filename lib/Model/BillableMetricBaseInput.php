...
class BillableMetricBaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'group' => '\LagoClient\Model\BillableMetricGroup'
    ];
    ...
    */
     ...
     *
     * @param string|null $aggregation_type Aggregation method used to compute usage for this billable metric. Possible values are `count_agg`, `sum_agg`, `max_agg` or `unique_count_agg`.
     *
     * @return self
     */
     ...
     * Gets group
     *
     * @return \LagoClient\Model\BillableMetricGroup|null
     */
     ...
     * Sets group
     *
     * @param \LagoClient\Model\BillableMetricGroup|null $group group
     *
     * @return self
     */
