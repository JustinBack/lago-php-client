...
class CreditObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'before_vat' => 'bool',
        'item' => '\LagoClient\Model\CreditObjectItem',
        'invoice' => '\LagoClient\Model\CreditObjectInvoice'
    ];
    ...
    */
     ...
     * Sets before_vat
     *
     * @param bool $before_vat Indicates whether the credit is applied on the amount before taxes (coupons) or after taxes (credit notes). This flag helps determine the order in which credits are applied to the invoice calculation
     *
     * @return self
     */
     ...
     * Gets item
     *
     * @return \LagoClient\Model\CreditObjectItem
     */
     ...
     * Sets item
     *
     * @param \LagoClient\Model\CreditObjectItem $item item
     *
     * @return self
     */
     ...
     * Gets invoice
     *
     * @return \LagoClient\Model\CreditObjectInvoice
     */
     ...
     * Sets invoice
     *
     * @param \LagoClient\Model\CreditObjectInvoice $invoice invoice
     *
     * @return self
     */
