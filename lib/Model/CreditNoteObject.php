...
class CreditNoteObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'file_url' => 'string',
        'items' => '\LagoClient\Model\CreditNoteItemObject[]',
        'applied_taxes' => '\LagoClient\Model\CreditNoteAppliedTaxObject[]'
    ];
    ...
    */
     ...
     *
     * @param int $coupons_adjustement_amount_cents The pro-rated amount of the coupons applied to the source invoice.
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \LagoClient\Model\CreditNoteItemObject[]|null
     */
     ...
     * Sets items
     *
     * @param \LagoClient\Model\CreditNoteItemObject[]|null $items Array of credit note’s items.
     *
     * @return self
     */
     ...
     * Gets applied_taxes
     *
     * @return \LagoClient\Model\CreditNoteAppliedTaxObject[]|null
     */
     ...
     * Sets applied_taxes
     *
     * @param \LagoClient\Model\CreditNoteAppliedTaxObject[]|null $applied_taxes applied_taxes
     *
     * @return self
     */
