...
class CreditNoteItemObjectFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'applied_taxes' => '\LagoClient\Model\FeeAppliedTaxObject[]'
    ];
    ...
    */
     ...
     *
     * @param string|null $lago_subscription_id Unique identifier assigned to the subscription, created by Lago. This field is specifically displayed when the fee type is charge and the payment for the fee is made in advance (`pay_in_advance` is set to true).
     *
     * @return self
     */
     ...
     *
     * @param string|null $lago_customer_id Unique identifier assigned to the customer, created by Lago. This field is specifically displayed when the fee type is charge and the payment for the fee is made in advance (`pay_in_advance` is set to true).
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_customer_id Unique identifier assigned to the customer in your application. This field is specifically displayed when the fee type is charge and the payment for the fee is made in advance (`pay_in_advance` is set to true).
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_subscription_id Unique identifier assigned to the subscription in your application. This field is specifically displayed when the fee type is charge and the payment for the fee is made in advance (`pay_in_advance` is set to true).
     *
     * @return self
     */
     ...
     * Gets applied_taxes
     *
     * @return \LagoClient\Model\FeeAppliedTaxObject[]|null
     */
     ...
     * Sets applied_taxes
     *
     * @param \LagoClient\Model\FeeAppliedTaxObject[]|null $applied_taxes List of fee applied taxes
     *
     * @return self
     */
