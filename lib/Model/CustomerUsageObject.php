...
class CustomerUsageObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int $vat_amount_cents The tax amount in cents.
     *
     * @return self
     */
     ...
     *
     * @param Currency $vat_amount_currency vat_amount_currency
     *
     * @return self
     */
     ...
     * Gets charges_usage
     *
     * @return \LagoClient\Model\CustomerChargeUsageObject[]
     */
     ...
     * Sets charges_usage
     *
     * @param \LagoClient\Model\CustomerChargeUsageObject[] $charges_usage Array of charges that comprise the current usage. It contains detailed information about individual charge items associated with the usage.
     *
     * @return self
     */
