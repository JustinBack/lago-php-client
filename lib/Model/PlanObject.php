...
class PlanObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'charges' => '\LagoClient\Model\ChargeObject[]'
    ];
    ...
    */
     ...
     * Sets interval
     *
     * @param string $interval The interval used for recurring billing. It represents the frequency at which subscription billing occurs. The interval can be one of the following values: `yearly`, `monthly` or `weekly`.
     *
     * @return self
     */
     ...
     * Gets charges
     *
     * @return \LagoClient\Model\ChargeObject[]|null
     */
     ...
     * Sets charges
     *
     * @param \LagoClient\Model\ChargeObject[]|null $charges Additional usage-based charges for this plan.
     *
     * @return self
     */
