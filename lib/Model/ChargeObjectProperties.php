...
class ChargeObjectProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'graduated_ranges' => '\LagoClient\Model\ChargePropertiesGraduatedRangesInner[]',
        'amount' => 'string',
        'free_units' => 'int',
        'package_size' => 'int',
        'rate' => 'string',
        ...
        'volume_ranges' => '\LagoClient\Model\ChargePropertiesVolumeRangesInner[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'package_size' => null,
        'rate' => '^[0-9]+.?[0-9]*$',
        'fixed_amount' => '^[0-9]+.?[0-9]*$',
        'free_units_per_events' => null,
        'free_units_per_total_aggregation' => '^[0-9]+.?[0-9]*$',
        'volume_ranges' => null
    ];
    ...
    */
     ...
     *
     * @return \LagoClient\Model\ChargePropertiesGraduatedRangesInner[]|null
     */
     ...
     *
     * @param \LagoClient\Model\ChargePropertiesGraduatedRangesInner[]|null $graduated_ranges Graduated ranges, sorted from bottom to top tiers, used for a `graduated` charge model.
     *
     * @return self
     */
     ...
     * Gets volume_ranges
     *
     * @return \LagoClient\Model\ChargePropertiesVolumeRangesInner[]|null
     */
     ...
     * Sets volume_ranges
     *
     * @param \LagoClient\Model\ChargePropertiesVolumeRangesInner[]|null $volume_ranges Volume ranges, sorted from bottom to top tiers, used for a `volume` charge model.
     *
     * @return self
     */
