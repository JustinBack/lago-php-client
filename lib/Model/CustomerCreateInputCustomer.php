...
class CustomerCreateInputCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'city' => 'string',
        'country' => 'string',
        'currency' => '\LagoClient\Model\Currency',
        'email' => 'string',
        'legal_name' => 'string',
        'legal_number' => 'string',
        'logo_url' => 'string',
        ...
        'timezone' => '\LagoClient\Model\Timezone',
        'url' => 'string',
        'zipcode' => 'string',
        'billing_configuration' => '\LagoClient\Model\CustomerBillingConfiguration',
        'metadata' => '\LagoClient\Model\CustomerCreateInputCustomerMetadataInner[]'
    ];
    ...
    */
     ...
     * Sets country
     *
     * @param string|null $country Country code of the customer's billing address. Format must be ISO 3166 (alpha-2)
     *
     * @return self
     */
     ...
     *
     * @return \LagoClient\Model\CustomerBillingConfiguration|null
     */
     ...
     *
     * @param \LagoClient\Model\CustomerBillingConfiguration|null $billing_configuration billing_configuration
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \LagoClient\Model\CustomerCreateInputCustomerMetadataInner[]|null
     */
     ...
     * Sets metadata
     *
     * @param \LagoClient\Model\CustomerCreateInputCustomerMetadataInner[]|null $metadata Set of key-value pairs that you can attach to a customer. This can be useful for storing additional information about the customer in a structured format
     *
     * @return self
     */
