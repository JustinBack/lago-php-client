...
/**
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\Coupon
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Coupon, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\AppliedCouponsPaginated
     */
    public function findAllAppliedCoupons($status = null, $external_customer_id = null, string $contentType = self::contentTypes['findAllAppliedCoupons'][0])
    {
        list($response) = $this->findAllAppliedCouponsWithHttpInfo($status, $external_customer_id, $contentType);
        return $response;
    }
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\AppliedCouponsPaginated, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAllAppliedCouponsWithHttpInfo($status = null, $external_customer_id = null, string $contentType = self::contentTypes['findAllAppliedCoupons'][0])
    {
        $request = $this->findAllAppliedCouponsRequest($status, $external_customer_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllAppliedCouponsAsync($status = null, $external_customer_id = null, string $contentType = self::contentTypes['findAllAppliedCoupons'][0])
    {
        return $this->findAllAppliedCouponsAsyncWithHttpInfo($status, $external_customer_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllAppliedCouponsAsyncWithHttpInfo($status = null, $external_customer_id = null, string $contentType = self::contentTypes['findAllAppliedCoupons'][0])
    {
        $returnType = '\LagoClient\Model\AppliedCouponsPaginated';
        $request = $this->findAllAppliedCouponsRequest($status, $external_customer_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findAllAppliedCouponsRequest($status = null, $external_customer_id = null, string $contentType = self::contentTypes['findAllAppliedCoupons'][0])
    {
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\CouponsPaginated
     */
    public function findAllCoupons(string $contentType = self::contentTypes['findAllCoupons'][0])
    {
        list($response) = $this->findAllCouponsWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\CouponsPaginated, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllCouponsAsync(string $contentType = self::contentTypes['findAllCoupons'][0])
    {
        return $this->findAllCouponsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllCouponsAsyncWithHttpInfo(string $contentType = self::contentTypes['findAllCoupons'][0])
    {
        $returnType = '\LagoClient\Model\CouponsPaginated';
        $request = $this->findAllCouponsRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findAllCouponsRequest(string $contentType = self::contentTypes['findAllCoupons'][0])
    {
