...
/**
     ...
     *
     * @param  \LagoClient\Model\SubscriptionCreateInput $subscription_create_input Subscription payload (required)
     ...
     * @return \LagoClient\Model\Subscription|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorUnprocessableEntity
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Subscription|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorUnprocessableEntity, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSubscriptionWithHttpInfo($subscription_create_input, string $contentType = self::contentTypes['createSubscription'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LagoClient\Model\Subscription' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LagoClient\Model\Subscription' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LagoClient\Model\Subscription', []),
            ...
            $returnType = '\LagoClient\Model\Subscription';
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\Subscription|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorNotAllowed
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Subscription|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorNotAllowed, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\SubscriptionsPaginated|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\SubscriptionsPaginated|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAllSubscriptionsWithHttpInfo($page = null, $per_page = null, $external_customer_id = null, $plan_code = null, $status = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LagoClient\Model\SubscriptionsPaginated' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LagoClient\Model\SubscriptionsPaginated' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LagoClient\Model\SubscriptionsPaginated', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LagoClient\Model\SubscriptionsPaginated';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LagoClient\Model\SubscriptionsPaginated',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $external_id External ID of the existing subscription (required)
     * @param  \LagoClient\Model\SubscriptionUpdateInput $subscription_update_input Update an existing subscription (required)
