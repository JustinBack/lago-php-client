...
/**
     ...
     * @return \LagoClient\Model\Subscription
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Subscription, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\SubscriptionsPaginated
     */
    public function findAllSubscriptions($external_customer_id = null, $plan_code = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        list($response) = $this->findAllSubscriptionsWithHttpInfo($external_customer_id, $plan_code, $contentType);
        return $response;
    }
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\SubscriptionsPaginated, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAllSubscriptionsWithHttpInfo($external_customer_id = null, $plan_code = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        $request = $this->findAllSubscriptionsRequest($external_customer_id, $plan_code, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllSubscriptionsAsync($external_customer_id = null, $plan_code = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        return $this->findAllSubscriptionsAsyncWithHttpInfo($external_customer_id, $plan_code, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllSubscriptionsAsyncWithHttpInfo($external_customer_id = null, $plan_code = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        $returnType = '\LagoClient\Model\SubscriptionsPaginated';
        $request = $this->findAllSubscriptionsRequest($external_customer_id, $plan_code, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findAllSubscriptionsRequest($external_customer_id = null, $plan_code = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
