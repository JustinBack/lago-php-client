...
/**
     ...
     *
     * @param  \LagoClient\Model\InvoiceOneOffCreateInput $invoice_one_off_create_input Invoice payload (required)
     ...
     * @return \LagoClient\Model\Invoice|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorUnprocessableEntity
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Invoice|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorUnprocessableEntity, HTTP status code, HTTP response headers (array of strings)
     */
    public function createInvoiceWithHttpInfo($invoice_one_off_create_input, string $contentType = self::contentTypes['createInvoice'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LagoClient\Model\Invoice' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LagoClient\Model\Invoice' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LagoClient\Model\Invoice', []),
            ...
            $returnType = '\LagoClient\Model\Invoice';
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\Invoice|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Invoice|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\InvoicesPaginated|\LagoClient\Model\ApiErrorUnauthorized
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\InvoicesPaginated|\LagoClient\Model\ApiErrorUnauthorized, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAllInvoicesWithHttpInfo($page = null, $per_page = null, $external_customer_id = null, $issuing_date_from = null, $issuing_date_to = null, $status = null, $payment_status = null, string $contentType = self::contentTypes['findAllInvoices'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LagoClient\Model\InvoicesPaginated' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LagoClient\Model\InvoicesPaginated' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LagoClient\Model\InvoicesPaginated', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LagoClient\Model\InvoicesPaginated';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LagoClient\Model\InvoicesPaginated',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $lago_id Unique identifier assigned to the invoice within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the invoice’s record within the Lago system. (required)
     * @param  \LagoClient\Model\InvoiceUpdateInput $invoice_update_input Update an existing invoice (required)
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\Invoice|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorUnprocessableEntity
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Invoice|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorUnprocessableEntity, HTTP status code, HTTP response headers (array of strings)
     */
