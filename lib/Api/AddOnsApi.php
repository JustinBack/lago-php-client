...
/**
     ...
     * @return \LagoClient\Model\AppliedAddOn
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\AppliedAddOn, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\AddOn, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\AddOnsPaginated
     */
    public function findAllAddOns(string $contentType = self::contentTypes['findAllAddOns'][0])
    {
        list($response) = $this->findAllAddOnsWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\AddOnsPaginated, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAllAddOnsWithHttpInfo(string $contentType = self::contentTypes['findAllAddOns'][0])
    {
        $request = $this->findAllAddOnsRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllAddOnsAsync(string $contentType = self::contentTypes['findAllAddOns'][0])
    {
        return $this->findAllAddOnsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllAddOnsAsyncWithHttpInfo(string $contentType = self::contentTypes['findAllAddOns'][0])
    {
        $returnType = '\LagoClient\Model\AddOnsPaginated';
        $request = $this->findAllAddOnsRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findAllAddOnsRequest(string $contentType = self::contentTypes['findAllAddOns'][0])
    {
