...
/**
     ...
     *
     * @param  \LagoClient\Model\EventBatchInput $event_batch_input Batch events payload (required)
     ...
     * Send usage events
     *
     * @param  \LagoClient\Model\EventInput $event_input Event payload (required)
     ...
     *
     * @param  \LagoClient\Model\EventEstimateFeesInput $event_estimate_fees_input Event estimate payload (required)
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\Fees|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorUnprocessableEntity
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Fees|\LagoClient\Model\ApiErrorBadRequest|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound|\LagoClient\Model\ApiErrorUnprocessableEntity, HTTP status code, HTTP response headers (array of strings)
     */
    public function eventEstimateFeesWithHttpInfo($event_estimate_fees_input, string $contentType = self::contentTypes['eventEstimateFees'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LagoClient\Model\Fees' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LagoClient\Model\Fees' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LagoClient\Model\Fees', []),
            ...
            $returnType = '\LagoClient\Model\Fees';
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LagoClient\Model\Event|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound
     */
     ...
     * @throws \LagoClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LagoClient\Model\Event|\LagoClient\Model\ApiErrorUnauthorized|\LagoClient\Model\ApiErrorNotFound, HTTP status code, HTTP response headers (array of strings)
     */
    public function findEventWithHttpInfo($transaction_id, string $contentType = self::contentTypes['findEvent'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LagoClient\Model\Event' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LagoClient\Model\Event' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LagoClient\Model\Event', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LagoClient\Model\Event';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
